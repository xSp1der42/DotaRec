...
├── MarketplaceTab.js - торговая площадка
...
4. **Торговая площадка**: MarketplaceTab → marketplaceRoutes
...
**Текущая реализация уже содержит основную функциональность:**
- Просмотр объявлений
- Покупка карточек
- Отмена своих объявлений

**Улучшения:**
- Добавление возможности выставлять карточки из коллекции (не только из хранилища)
- Улучшенная фильтрация по сезону
- Проверка дубликатов при покупке

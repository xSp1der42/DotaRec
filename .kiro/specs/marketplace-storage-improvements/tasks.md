...
- [ ] 1. Обновить StorageTab - удалить перемещение в коллекцию и улучшить отображение
...
- [ ] 5. Обновить CardChoiceModal для обработки дубликатов
...
- [ ] 11. Создать CSS стили для новых компонентов и обновлений
